...
<body>
    <form id="form1" runat="server">
        <asp:Panel ID="Panel1" runat="server" BackColor="#6699FF" Height="503px" Width="1039px">
            ...
            <br />
            <asp:Panel ID="Panel2" runat="server" Height="455px" style="margin-left: 217px" Width="639px" BackImageUrl="~/2.png">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="txtid" runat="server">Enter ID to Delete</asp:TextBox>
                &nbsp;&nbsp;&nbsp;&nbsp;
